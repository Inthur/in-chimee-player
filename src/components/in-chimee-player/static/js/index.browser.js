...
var Gesture = function () {
  ...
  _createClass(Gesture, [{
    ...
    value: function touchmove(evt) {
      ...
      var distance = getDistance(this.startTouch.clientY, this.startTouch.clientY, touch.clientY, touch.clientY);
    ...
    value: function touchend(evt) {
      ...
      var time = Date.now();
      var distance = getDistance(this.startTouch.clientY, this.startTouch.clientY, this.endTouch.clientY, this.endTouch.clientY);
...
var ProgressBar = (_class$1 = function (_Base) {
  ...
  _createClass$1(ProgressBar, [{
    ...
    key: 'tap',
    value: function tap(e) {
      this._currentTime = (e.clientY - this.$dom[0].offsetLeft) / this.$dom[0].offsetWidth * this.parent.duration;
      this.update();
